          ...
          <div className={styles.cardGroup} ref={cardGroup}>
            <div className={`${styles.card} ${styles.cardV1}`}>
              <div className={styles.cardInner}>
                <div className={styles.cardTitle}>PRAMOD H</div>
                <div className={styles.cardDesc}>Senior Frontend Developer</div>
                <hr />
                <p>
                  I am Pramod, a senior frontend developer with over 3 years of
                ...
                <p>
                  Senior Frontend Developer | Codilar Technologies <br />
                </p>
              </div>
              <figure className={styles.figure}>
                <Image src="/p.png" alt="Pramod H" width={150} height={150} />
              </figure>
            </div>
